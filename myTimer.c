...
// Write a function that can intialize a Timer with particular values for pre-scale and count.
...
// Write a function that indicates whether Timer0 has expired.
...
// Write a function that indicates whether Timer1 has expired.
